  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text('Regler og Vilkår', style: theme.primaryTextTheme.headline1),
          actions: [
            Padding(
              ...
              child: TextButton(
                  ...
                  child: Text(
                    'Accepter',
                    style: theme.primaryTextTheme.headline1!.copyWith(fontSize: 15),
                  )),
            ),
          ],
        ),
        body: SingleChildScrollView(
          child: Padding(
            ...
            child: Text(
              pdfText,
              style: theme.primaryTextTheme.headline1!.copyWith(fontSize: 15, color: Colors.black),
            ),
          ),
        ));
  }
